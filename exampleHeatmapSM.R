...
my_palette
setwd("~/Documents/PhDProjects/PANCAN24_Analysis/")
prefix <- file.path("~/Documents","PhDProjects","PANCAN24_Analysis", "Data")
prefix

icbp_status <- read.table(file.path(prefix,"icbpstatus.txt"), row.names = 1, header=T, sep="\t")
icbp_status
...
er_pr_her2_status2 <- readRDS(file.path(prefix,"tcga_er_pr_her2_formatted.rds"))
er_pr_her2_status2

intrinsic <- read.table(file.path(prefix,"intrinsic.txt"), row.names = 1, header=T,sep="\t")
